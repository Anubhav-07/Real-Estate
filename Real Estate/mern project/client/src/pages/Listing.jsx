                ...
                <div>
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        <div className='flex gap-4'>
                            <p className='bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-md text-lg'>
                                {listing.type === 'rent' ? 'For Rent' : 'For Sale'}
                            </p>
                            {listing.offer && (
                                <p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md text-lg'>${+listing.regularPrice - +listing.discountPrice} OFF </p>
                            )}
                        </div>
                        <p className='text-slate-800 text-lg'>
                            <span className='font-semibold text-black text-xl'>Description - </span>
                            {listing.description}
                        </p>
